...
public class AboutInnerClasses {
    ...
    public void creatingAnonymousInnerClasses() {
        ...
        };// <- Why do you need a semicolon here? End of variable declaration
    ...
    public void innerClassAndInheritanceOther() {
        ...
        // Inner doesn't extends AboutInnerClasses, so inner classes don't automatically extend parent classes
    ...
    public void staticInnerClass() {
        ...
        // Does it work? Why not? it cant access non static members
    }
